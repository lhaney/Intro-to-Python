...
for i in range (0,3): #3 is the number of students you would like to log in this log.
    ...
    print name, "your average score is", (a+b+c)/3 #3 is the number of students you would like to log in this log.
    if (a+b+c)/3 > 70: #80 is the average score you expect students to have in order to pass the course. #3 is the number of students you would like to log in this log.
            print "nice job"
    elif (a+b+c)/3 < 70: #80 is the average score you expect students to have in order to pass the course. #3 is the number of students you would like to log in this log.
            print "work harder!"
